    ...
    <div className="bg-[#011627] py-8 md:py-14 text-2xl text-white font-mono ">
        ...
        <div className="font-thin mt-5 hover:bg-gra">
            ...
            <div className="w-[100%] hover:bg-gray-700 bg-gray-800  p-4 mt-5">
             <a href="https://ecommerce-aais.vercel.app" target="_blank" rel="noreferrer"><h1 className="text-2xl mb-3">Ecommerce Site</h1>
             <div className="text-xl">Used <span className="font-bold">React JS</span> for the Front-End, <span className="font-bold">Redux Toolkit</span> for State Management and <span className="font-bold">fakeapi.platzi Api</span> for products</div>
             </a>
            </div>
            <div className="w-[100%] hover:bg-gray-700 bg-gray-800  p-4 mt-5">
             <a href="https://github.com/aais1/blog" target="_blank" rel="noreferrer"><h1 className="text-2xl mb-3">Blog App</h1>
             <div className="text-xl">Used <span className="font-bold">React JS</span> for the Front-End , <span className="font-bold">Express</span> for Backend <span className="font-bold">MongoDB</span> for Database</div>
             </a>
            </div>
            <div className="w-[100%] hover:bg-gray-700 bg-gray-800  p-4 mt-5">
             <a href="https://aais1.github.io/Quiz-Game/" target="_blank" rel="noreferrer"><h1 className="text-2xl mb-3">Quiz Game</h1>
             <div className="text-xl">Used <span className="font-bold">HTMl CSS & JS</span></div>
             </a>
            </div>
        </div>
